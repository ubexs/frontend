...
exports.WWWSupportController = void 0;
const common_1 = require("@tsed/common");
const model = require("../../models");
const base_1 = require("../base");
const moment = require("moment");
const middleware = require("../../middleware/v1");
let WWWSupportController = class WWWSupportController extends base_1.default {
    constructor() {
        super();
    }
    SupportPage() {
    ...
    async SupportTicket(cookies, userInfo, ticketId) {
        ticketId = base_1.default.ValidateId(ticketId);
    ...
    async SupportTicketReply(cookies, userInfo, ticketId) {
        ticketId = base_1.default.ValidateId(ticketId);
        const baseService = new this.base({
            cookie: cookies,
        });
...
], WWWSupportController.prototype, "SupportPage", null);
__decorate([
    ...
    __param(2, common_1.PathParams('ticketId', Number)),
    __metadata("design:type", Function),
...
__decorate([
    common_1.Get('/signup-help'),
    common_1.Render('support_article'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], WWWSupportController.prototype, "SignupHelpSupport", null);
__decorate([
...
__decorate([
    common_1.Get('/account-banned-help'),
    common_1.Render('support_article'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], WWWSupportController.prototype, "AccountBannedSupport", null);
__decorate([
    common_1.Get('/account-hacked'),
    common_1.Render('support_article'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], WWWSupportController.prototype, "AccountHackedSupport", null);
__decorate([
    common_1.Get('/scammed'),
    common_1.Render('support_article'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], WWWSupportController.prototype, "ScammedSupport", null);
__decorate([
    common_1.Get('/ad-system'),
    common_1.Render('support_article'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], WWWSupportController.prototype, "AdSystemSupport", null);
__decorate([
    common_1.Get('/developer-get-started'),
    common_1.Render('support_article'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], WWWSupportController.prototype, "DeveloperGetStarted", null);
